...
public class Practice13GetTextBoundsView extends View {
...

    {
        ...
        paint2.getTextBounds(text1, 0, text1.length(), mBound);
        Log.d("-->>45",mBound.left+":"+mBound.top+":"+mBound.bottom);
        yOffsets[0]=-(mBound.top+mBound.bottom)/2;
        paint2.getTextBounds(text2, 0, text2.length(), mBound);
        yOffsets[1]=-(mBound.top+mBound.bottom)/2;
        paint2.getTextBounds(text3, 0, text3.length(), mBound);
        yOffsets[2]=-(mBound.top+mBound.bottom)/2;
        paint2.getTextBounds(text4, 0, text4.length(), mBound);
        yOffsets[3]=-(mBound.top+mBound.bottom)/2;
    }
